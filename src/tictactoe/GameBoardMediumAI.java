...
public class GameBoardMediumAI extends JFrame {
	 ...
	 */
	static GameBoardMediumAI frame;
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					frame = new GameBoardMediumAI();
	...
	private static ArrayList<Integer> humanwincells=new ArrayList<Integer>();
	boolean win=false;
	...
	public int checkSelfWin() {
		int move=0;
		/*Row 1*/
		if((val1.equals("O")||val2.equals("O"))&&val2.equals(val1)&&val3.isEmpty()==true) {
			move=3;
		}
		else if((val1.equals("O")||val3.equals("O"))&&val3.equals(val1)&&val2.isEmpty()==true) {
			move=2;
		}
		else if((val2.equals("O")||val3.equals("O"))&&val3.equals(val2)&&val1.isEmpty()==true) {
			move=1;
		}
		/*Row2*/
		else if((val4.equals("O")||val5.equals("O"))&&val5.equals(val4)&&val6.isEmpty()==true) {
			move=6;
		}
		else if((val4.equals("O")||val6.equals("O"))&&val6.equals(val4)&&val5.isEmpty()==true) {
			move=5;
		}
		else if((val5.equals("O")||val6.equals("O"))&&val6.equals(val5)&&val4.isEmpty()==true) {
			move=4;
		}
		/*Row 3*/
		else if((val7.equals("O")||val8.equals("O"))&&val8.equals(val7)&&val9.isEmpty()==true) {
			move=9;
		}
		else if((val7.equals("O")||val9.equals("O"))&&val9.equals(val7)&&val8.isEmpty()==true) {
			move=8;
		}
		else if((val8.equals("O")||val9.equals("O"))&&val9.equals(val8)&&val7.isEmpty()==true) {
			move=7;
		}
		/*Case Vertical*/
		/*Column 1*/
		else if((val1.equals("O")||val4.equals("O"))&&val4.equals(val1)&&val7.isEmpty()==true) {
			move=7;
		}
		else if((val1.equals("O")||val7.equals("O"))&&val7.equals(val1)&&val4.isEmpty()==true) {
			move=4;
		}
		else if((val4.equals("O")||val7.equals("O"))&&val7.equals(val4)&&val1.isEmpty()==true) {
			move=1;
		}
		/*Column2*/
		else if((val2.equals("O")||val5.equals("O"))&&val5.equals(val2)&&val8.isEmpty()==true) {
			move=8;
		}
		else if((val2.equals("O")||val8.equals("O"))&&val8.equals(val2)&&val5.isEmpty()==true) {
			move=5;
		}
		else if((val5.equals("O")||val8.equals("O"))&&val8.equals(val5)&&val2.isEmpty()==true) {
			move=2;
		}
		/*Column3*/
		else if((val3.equals("O")||val6.equals("O"))&&val6.equals(val3)&&val9.isEmpty()==true) {
			move=9;
		}
		else if((val3.equals("O")||val9.equals("O"))&&val9.equals(val3)&&val6.isEmpty()==true) {
			move=6;
		}
		else if((val6.equals("O")||val9.equals("O"))&&val9.equals(val6)&&val3.isEmpty()==true) {
			move=3;
		}
		/*Case Diagonal*/
		else if((val1.equals("O")||val5.equals("O"))&&val5.equals(val1)&&val9.isEmpty()==true) {
			move=9;
		}
		else if((val1.equals("O")||val5.equals("O"))&&val9.equals(val1)&&val5.isEmpty()==true) {
			move=5;
		}
		else if((val5.equals("O")||val9.equals("O"))&&val9.equals(val5)&&val1.isEmpty()==true) {
			move=1;
		}
		/*Opposite Diagonal*/
		else if((val3.equals("O")||val5.equals("O"))&&val5.equals(val3)&&val7.isEmpty()==true) {
			move=7;
		}
		else if((val3.equals("O")||val7.equals("O"))&&val7.equals(val3)&&val5.isEmpty()==true) {
			move=5;
		}
		else if((val5.equals("O")||val7.equals("O"))&&val7.equals(val5)&&val3.isEmpty()==true) {
			move=3;
		}
		return move;
	}
	public int predictMove() {
		...
		if(move==0) {
		/*Row 1*/
		if((val1.equals("X")||val2.equals("X"))&&val2.equals(val1)&&val3.isEmpty()==true) {
			move=3;
		}
		else if((val1.equals("X")||val3.equals("X"))&&val3.equals(val1)&&val2.isEmpty()==true) {
			move=2;
		}
		else if((val2.equals("X")||val3.equals("X"))&&val3.equals(val2)&&val1.isEmpty()==true) {
			move=1;
		}
		/*Row2*/
		else if((val4.equals("X")||val5.equals("X"))&&val5.equals(val4)&&val6.isEmpty()==true) {
			move=6;
		}
		else if((val4.equals("X")||val6.equals("X"))&&val6.equals(val4)&&val5.isEmpty()==true) {
			move=5;
		}
		else if((val5.equals("X")||val6.equals("X"))&&val6.equals(val5)&&val4.isEmpty()==true) {
			move=4;
		}
		/*Row 3*/
		else if((val7.equals("X")||val8.equals("X"))&&val8.equals(val7)&&val9.isEmpty()==true) {
			move=9;
		}
		else if((val7.equals("X")||val9.equals("X"))&&val9.equals(val7)&&val8.isEmpty()==true) {
			move=8;
		}
		else if((val8.equals("X")||val9.equals("X"))&&val9.equals(val8)&&val7.isEmpty()==true) {
			move=7;
		}
		/*Case Vertical*/
		/*Column 1*/
		else if((val1.equals("X")||val4.equals("X"))&&val4.equals(val1)&&val7.isEmpty()==true) {
			move=7;
		}
		else if((val1.equals("X")||val7.equals("X"))&&val7.equals(val1)&&val4.isEmpty()==true) {
			move=4;
		}
		else if((val4.equals("X")||val7.equals("X"))&&val7.equals(val4)&&val1.isEmpty()==true) {
			move=1;
		}
		/*Column2*/
		else if((val2.equals("X")||val5.equals("X"))&&val5.equals(val2)&&val8.isEmpty()==true) {
			move=8;
		}
		else if((val2.equals("X")||val8.equals("X"))&&val8.equals(val2)&&val5.isEmpty()==true) {
			move=5;
		}
		else if((val5.equals("X")||val8.equals("X"))&&val8.equals(val5)&&val2.isEmpty()==true) {
			move=2;
		}
		/*Column3*/
		else if((val3.equals("X")||val6.equals("X"))&&val6.equals(val3)&&val9.isEmpty()==true) {
			move=9;
		}
		else if((val3.equals("X")||val9.equals("X"))&&val9.equals(val3)&&val6.isEmpty()==true) {
			move=6;
		}
		else if((val6.equals("X")||val9.equals("X"))&&val9.equals(val6)&&val3.isEmpty()==true) {
			move=3;
		}
		/*Case Diagonal*/
		else if((val1.equals("X")||val5.equals("X"))&&val5.equals(val1)&&val9.isEmpty()==true) {
			move=9;
		}
		else if((val1.equals("X")||val5.equals("X"))&&val9.equals(val1)&&val5.isEmpty()==true) {
			move=5;
		}
		else if((val5.equals("X")||val9.equals("X"))&&val9.equals(val5)&&val1.isEmpty()==true) {
			move=1;
		}
		/*Opposite Diagonal*/
		else if((val3.equals("X")||val5.equals("X"))&&val5.equals(val3)&&val7.isEmpty()==true) {
			move=7;
		}
		else if((val3.equals("X")||val7.equals("X"))&&val7.equals(val3)&&val5.isEmpty()==true) {
			move=5;
		}
		else if((val5.equals("X")||val7.equals("X"))&&val7.equals(val5)&&val3.isEmpty()==true) {
			move=3;
		}
		}
		return move;
